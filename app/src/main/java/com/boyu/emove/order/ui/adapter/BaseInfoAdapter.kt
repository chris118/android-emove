...
@Inject constructor() : RecyclerView.Adapter<BaseInfoAdapter.ViewHolder>() {

    internal var data: List<BaseInfo> by Delegates.observable(ArrayList()) {
        _, _, _ ->
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseInfoAdapter.ViewHolder {
        return ViewHolder(parent.inflate(R.layout.item_cell_order), viewType)
    }

    @SuppressLint("NewApi")
    override fun onBindViewHolder(holder: BaseInfoAdapter.ViewHolder, position: Int) {
